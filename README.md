...
| Assets and scenes | `anima::assets` | GLB import, shared meshes, objects/components, hierarchy, additive scenes, prefabs/variants, animation, cameras and directional lighting |
