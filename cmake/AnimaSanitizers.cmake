    ...
    foreach(configuration IN LISTS configurations)
        ...
        foreach(language C CXX)
            ...
            if(flags MATCHES "(^|[ \t])[-/]RTC[^ \t]*([ \t]|$)" OR
               flags MATCHES "(^|[ \t])[-/]ZI([ \t]|$)")
                message(FATAL_ERROR "MSVC ASan is incompatible with /RTC and /ZI in ${language} ${configuration} flags; use /Zi and disable runtime checks")
            endif()
        endforeach()
    endforeach()
endfunction()
