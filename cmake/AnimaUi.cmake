...
if(ANIMA_BUILD_TESTS)
    ...
    target_link_libraries(anima_ui_destruction_tests PRIVATE anima::ui_documents RmlUi::Core)
    anima_target_defaults(anima_ui_destruction_tests)
    foreach(scenario IN ITEMS own_callback other_host)
        add_test(NAME ui_destruction_${scenario} COMMAND anima_ui_destruction_tests ${scenario})
    endforeach()
endif()
